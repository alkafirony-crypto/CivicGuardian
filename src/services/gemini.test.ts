...
const valid={issueType:"Road Infrastructure",severity:"High",confidenceScore:82,safetyRisk:"Visible surface break may pose a traffic hazard.",priority:"High",description:"Road surface damage is visible.",observedEvidence:["Broken road surface"],imageQuality:"Good",needsHumanReview:false};
